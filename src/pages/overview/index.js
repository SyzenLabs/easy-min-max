						...
						<div className="grid gap-6 lg:grid-cols-[1.4fr_220px] lg:items-center">
							<VStack spacing={ 4 } alignment="topLeft">
								<VStack spacing={ 2 } alignment="topLeft">
									...
									>
										{ __(
											'SyzenLabs Quantity Limits helps you enforce minimum and maximum quantity or price rules across your WooCommerce store without overcomplicating setup.',
											'syzenlabs-quantity-limits'
										) }
									</Text>
								</VStack>
							...
							<div className="flex justify-center lg:justify-end">
								<img
									...
									height="167"
									alt={ __(
										'SyzenLabs Quantity Limits overview illustration',
										'syzenlabs-quantity-limits'
									) }
								/>
							</div>
						...
						<CardBody className="h-full">
							<VStack spacing={ 4 } alignment="topLeft" className="h-full justify-between">
								<VStack spacing={ 2 } alignment="topLeft">
									...
									>
										{ __(
											'What you can do with SyzenLabs Quantity Limits',
											'syzenlabs-quantity-limits'
										) }
									</Text>
									<Text variant="muted">
						...
						<CardBody>
							<VStack spacing={ 4 } alignment="topLeft">
								<VStack spacing={ 2 } alignment="topLeft">
									...
									>
										{ __(
											'Enjoying SyzenLabs Quantity Limits?',
											'syzenlabs-quantity-limits'
										) }
									</Text>
									<Text variant="muted">
										{ __(
											'If SyzenLabs Quantity Limits is helping you manage quantity rules more smoothly, a quick review on WordPress.org helps more store owners discover it.',
											'syzenlabs-quantity-limits'
										) }
									</Text>
								</VStack>
