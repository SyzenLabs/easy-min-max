...
const excludedFiles = [
	...
	'!*.md',
	'!*.jsonc',
	'!./assets/js/syzeql-wc-shipping-settings.js',
	'!./assets/css/syzeql-backend-temp.css',
	'!./scripts/**',
	'!./vendor/**',
];
...
gulp.task( 'sass_compile', function () {
	return gulp
		...
		.pipe( rename( 'syzeql-backend-temp.css' ) )
		.pipe( gulp.dest( './assets/css' ) );
} );

gulp.task( 'tailwind_compile', function () {
	return gulp
		.src( './assets/css/syzeql-backend-temp.css', {
			allowEmpty: true,
		} )
		.pipe( cached( 'tailwind' ) )
		.pipe(
			shell(
				'npx @tailwindcss/cli -i ./assets/css/syzeql-backend-temp.css -o ./src/style-generated.css --config ./tailwind.config.js'
			)
		)
...
gulp.task( 'autoprefix_compile', function () {
	return (
		gulp
			.src( './assets/css/syzeql-backend.css', { allowEmpty: true } )
...
gulp.task( 'datatable_css', function () {
	return gulp
		...
		.pipe( rename( 'syzeql-backend-datatable.css' ) )
...
gulp.task( 'datatable_css_rtl', function () {
	return gulp
		...
		.pipe( rename( 'syzeql-backend-datatable-rtl.css' ) )
